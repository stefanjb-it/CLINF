...
namespace CLINFGL.GraphReadEmailDemo
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var messages = _graphServiceClient.Users["admin.joebstst21@stevenelectric.onmicrosoft.com"].Messages.GetAsync().Result;
            foreach (var message in messages.Value.Take(3))
            {
